...
function timeConverter(timeInMilSeconds: number): ConvertedValue {
  const timeInSeconds = timeInMilSeconds * 1000;
  const timeSec = (moment as any).preciseDiff(0, timeInSeconds);
