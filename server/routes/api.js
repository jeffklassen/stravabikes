...
export const routes = (app) => {
  ...
  apiRoutes.get("/loadActivities", async (req, res) => {
    let activities = await athleteController.loadActivities(
  ...
  apiRoutes.get("/athleteSummary", async (req, res) => {
    try {
      let summary = await athleteController.getSummary(
        req.sessionData.athleteId
      );
  ...
  apiRoutes.get("/activities", async (req, res) => {
    try {
      let activities = await athleteController.getActivities(
        req.sessionData.athleteId
      );
